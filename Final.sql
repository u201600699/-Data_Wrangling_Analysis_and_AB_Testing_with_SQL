...
-- PREGUNTA 1
--Compare the final_assignments_qa table to the assignment events 
--we captured for user_level_testing. Write an answer to the following question: 
--Does this table have everything you need to compute metrics like 30-day view-binary?

-- respuesta No. The created_at date is needed.
...
FROM dsv1069.final_assignments_qa;
--PREGUNTA 3
--Use the final_assignments table to calculate the order binary
-- for the 30 day window after the test assignment for item_test_2
